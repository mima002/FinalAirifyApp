    ...
    return (
        <div className = "city">
            ...
            <div className ="index-info">
                Air quality index is 41, which is similar to yesterday at about this time.
            </div>
            ...
            <div className ="primary-pollutant-box">
                ...
                <div className='primary-pollutant-detail'>
                    PM2.5 particles are small enough to enter the bloodstream and typically 
                    result from wildfires, smokestacks, bacteria, or small dust particles.
                </div>
